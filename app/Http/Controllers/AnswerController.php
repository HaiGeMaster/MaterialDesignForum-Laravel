...
class AnswerController extends Controller
{
  ...
  public static function AddAnswer($question_id, $content_markdown, $content_rendered, $user_token)
  {
    ...
    if (
      ...
      if ($is_add) {
        ...
        UserModel::AddAnswerCount($user_id); //['user'];
  ...
  public static function GetAnswers(
    ...
    if ($search_field == []) {
      $search_field = AnswerModel::$search_field;
    }
  ...
  public static function DeleteAnswers($answer_ids, $user_token)
  {
    ...
    if (
      ...
      $answers = AnswerModel::whereIn('answer_id', $answer_ids)->get();
      foreach ($answers as $key => $answer) {
        if (
          ...
          UserModel::SubAnswerCount($answer->user_id);
    ...
    //   )
    // ) {
    //   $is_delete = AnswerModel::whereIn('answer_id', $answer_ids)
    //     ->where('delete_time', '=', 0)
    //     ->update([
